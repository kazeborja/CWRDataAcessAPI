from app import db
from app.daos import AgreementDAO, AgreementTypeDAO, TerritoryDAO, AgreementRoleDAO, SocietyDAO, SharesDAO, \
    InterestedPartyDAO, DistributionCategoryDAO, TextMusicRelationshipDAO, CompositeTypeDAO, VersionTypeDAO, \
    ExcerptTypeDAO, MusicArrangementDAO, LyricAdaptationDAO, WorkTypeDAO, WorkDAO
...
class AgreementService(GenericService):
    """
    Service for agreement dao
    """
    ...
    def __init__(self):
        ...
        """
        super(AgreementService, self).__init__()
        self.dao = AgreementDAO()

    def get_agreements_by_type(self, agreement_type):

        return self.tm.execute(self.dao, self.dao.get_agreements_by_type, agreement_type)

    def get_last(self):
        return self.tm.execute(self.dao, self.dao.get_last())
...
class InterestedPartyService(GenericService):

    def __init__(self):
        super(InterestedPartyService, self).__init__()
        self.dao = InterestedPartyDAO()
...
class SharesService(GenericService):

    def __init__(self):
        super(SharesService, self).__init__()
        self.dao = SharesDAO()
...
class WorkService(GenericService):

    def __init__(self):
        super(WorkService, self).__init__()
        self.dao = WorkDAO()

    def get_by_iswc(self, iswc):
        return self.tm.execute(self.dao, self.dao.get_by_iswc, iswc)
