import os
import xlrd
from app.files import __data__

__author__ = 'Borja'

from app import db
from app.services import AgreementTypeService, AgreementRoleService, SocietyService, DistributionCategoryService, \
    TextMusicRelationshipService, CompositeTypeService, VersionTypeService, ExcerptTypeService, MusicArrangementService, \
    LyricAdaptationService, WorkTypeService
from app.services import TerritoryService
from model.models import AgreementType, AgreementRole, Society, DistributionCategory, TextMusicRelationship, \
    CompositeType, VersionType, ExcerptType, MusicArrangement, LyricAdaptation, WorkType
from model.models import Territory
